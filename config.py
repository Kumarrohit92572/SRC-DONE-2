...
BOT_TOKEN = getenv("BOT_TOKEN", "8437397688:AAEBOI2a2cIQE6q_HqaFwmlnovWfMqZn54w")
OWNER_ID = list(map(int, getenv("OWNER_ID", "6039166844").split()))
...
LOG_GROUP = getenv("LOG_GROUP", "-1002515907603")
CHANNEL_ID = int(getenv("CHANNEL_ID", "-1002515907603"))
